...
if __name__ == '__main__':
    ...
    parses.add_argument("-f","--filtervcf", metavar="OUT.vcf", type=str, help="Filter VCF output filename to write the called and refined SVs to. If the given filename ends with .gz, the VCF file will be automatically bgzipped and a .tbi index built for it.")
    ...
    parses.add_argument('-p',"--prefix",  type=str, help="The prefix of output")
    ...
    config.vcf = args.outpath + "/" + args.prefix + '_HighQ.vcf'
    config.filtervcf = args.outpath + "/" + args.prefix + '_Candidate.vcf'
